...
public final class LimitServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.server.app.fxLimit.GetLimitsByKeyRequest,
      grpc.server.app.fxLimit.GetLimitsByKeyResponse> getGetLimitsByKeyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetLimitsByKey",
      requestType = grpc.server.app.fxLimit.GetLimitsByKeyRequest.class,
      responseType = grpc.server.app.fxLimit.GetLimitsByKeyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.server.app.fxLimit.GetLimitsByKeyRequest,
      grpc.server.app.fxLimit.GetLimitsByKeyResponse> getGetLimitsByKeyMethod() {
    io.grpc.MethodDescriptor<grpc.server.app.fxLimit.GetLimitsByKeyRequest, grpc.server.app.fxLimit.GetLimitsByKeyResponse> getGetLimitsByKeyMethod;
      ...
      synchronized (LimitServiceGrpc.class) {
        if ((getGetLimitsByKeyMethod = LimitServiceGrpc.getGetLimitsByKeyMethod) == null) {
          LimitServiceGrpc.getGetLimitsByKeyMethod = getGetLimitsByKeyMethod =
              io.grpc.MethodDescriptor.<grpc.server.app.fxLimit.GetLimitsByKeyRequest, grpc.server.app.fxLimit.GetLimitsByKeyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetLimitsByKey"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.server.app.fxLimit.GetLimitsByKeyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.server.app.fxLimit.GetLimitsByKeyResponse.getDefaultInstance()))
  ...
  public static abstract class LimitServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getLimitsByKey(grpc.server.app.fxLimit.GetLimitsByKeyRequest request,
        io.grpc.stub.StreamObserver<grpc.server.app.fxLimit.GetLimitsByKeyResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                grpc.server.app.fxLimit.GetLimitsByKeyRequest,
                grpc.server.app.fxLimit.GetLimitsByKeyResponse>(
  ...
  public static final class LimitServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<LimitServiceBlockingStub> {
     ...
     * </pre>
     */
    public grpc.server.app.fxLimit.GetLimitsByKeyResponse getLimitsByKey(grpc.server.app.fxLimit.GetLimitsByKeyRequest request) {
  ...
  public static final class LimitServiceFutureStub extends io.grpc.stub.AbstractFutureStub<LimitServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.server.app.fxLimit.GetLimitsByKeyResponse> getLimitsByKey(
        grpc.server.app.fxLimit.GetLimitsByKeyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_LIMITS_BY_KEY:
          serviceImpl.getLimitsByKey((grpc.server.app.fxLimit.GetLimitsByKeyRequest) request,
              (io.grpc.stub.StreamObserver<grpc.server.app.fxLimit.GetLimitsByKeyResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class LimitServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.server.app.fxLimit.FxLimit.getDescriptor();
    }
